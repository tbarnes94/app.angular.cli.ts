...
export class CommonRouteReuseStrategy implements RouteReuseStrategy
{
   ...
   */
  public retrieve<T extends DetachedRouteHandle>( route : ActivatedRouteSnapshot ) : DetachedRouteHandle | null { return null ; }
   ...
   */
  public shouldAttach( route : ActivatedRouteSnapshot ) : boolean { return this.hasHandler( route ) ; }

  /**
   * https://angular.io/api/router/RouteReuseStrategy#shouldDetach
   */
  public shouldDetach( route : ActivatedRouteSnapshot ) : boolean { return this.hasDetach( route ) ; }

  /**
   * https://angular.io/api/router/RouteReuseStrategy#isEqual
   */
  public isEqual( a : ActivatedRouteSnapshot , b : ActivatedRouteSnapshot ) : boolean { return ( a.routeConfig === b.routeConfig ) ; }

  /**
   * https://angular.io/api/router/RouteReuseStrategy#hasComponent
   */
  public hasComponent( route : ActivatedRouteSnapshot ) : boolean { return ( !!route.component && !!( route.component as any ).name ) ; }

  /**
   * https://angular.io/api/router/RouteReuseStrategy#hasHandler
   */
  public hasHandler( route : ActivatedRouteSnapshot ) : boolean { return false ; }
   ...
   */
  public hasDetach( route : ActivatedRouteSnapshot ) : boolean { return false ; }
