...
const route: Routes = [
  ...
  { path: 'forms',  component: DashboardFormsComponent, data: { key: 'dashboard.forms' }, /*canActivate: [ AuthGuard ]*/ },
  { path: 'table',  component: DashboardTableComponent, data: { key: 'dashboard.table' }, /*canActivate: [ AuthGuard ]*/ },
];
